...
Perform a thorough evaluation of PR-B against the established criteria (same rubric as PR-A for fair comparison).
...
- [ ] **Read evaluation criteria**: Load `{{AUTORUN_FOLDER}}/EVALUATION_CRITERIA.md` to ensure consistent rubric application.

- [ ] **Re-fetch PR-B diff if needed**: Ensure you have the full diff available for analysis.
...
- [ ] **Identify gems**: What does PR-B do particularly well? Any clever solutions, good patterns, or thoughtful touches that should be preserved regardless of outcome?

### Task 10: Create PR-B Evaluation Document

- [ ] **Write PR_B_EVALUATION.md**: Create `{{AUTORUN_FOLDER}}/PR_B_EVALUATION.md`:
...
[What PR-B does particularly well - preserve these regardless of outcome]
...
**Next**: Document 4 will compare both evaluations side-by-side.
